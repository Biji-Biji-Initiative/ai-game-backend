...
class UserDTOMapper {
    ...
    static fromRequest(requestBody) {
        ...
        const { email, firstName, lastName, fullName, professionalTitle, location, country, focusArea, preferences, status } = requestBody;
        ...
        if (professionalTitle)
            params.professionalTitle = professionalTitle.trim();
        if (location)
            params.location = location.trim();
        if (country)
            params.country = country.trim();
        if (focusArea)
            params.focusArea = focusArea.trim();
