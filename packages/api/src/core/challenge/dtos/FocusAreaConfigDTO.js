...
class FocusAreaConfigDTOMapper {
    ...
    static fromRequest(requestBody) {
        ...
        const { code, name, description, relatedAreas, prerequisites, learningOutcomes, isActive, displayOrder, } = requestBody;
        ...
        return {
            ...
            prerequisites: Array.isArray(prerequisites)
                ...
                : [],
            learningOutcomes: learningOutcomes && typeof learningOutcomes === 'object' ? learningOutcomes : {},
            isActive: isActive !== undefined ? Boolean(isActive) : null,
            displayOrder: displayOrder !== undefined ? parseInt(displayOrder, 10) : null,
        };
    }
}
export { FocusAreaConfigDTO };
export { FocusAreaConfigDTOMapper };
export default {
    FocusAreaConfigDTO,
