...
class Logger {
   ...
   */
  private log(level: LogLevel, message: string, data?: any, source?: string): LogEntry {
    ...
    // Notify listeners
    console.log(`Logger: New log [${level}] from ${source || 'Unknown'}: ${message}`);
   ...
   */
  warn(message: string, data?: any, source?: string): LogEntry {
   ...
   */
  error(message: string, data?: any, source?: string): LogEntry {
