...
import { useGameStore, GamePhase, FocusArea } from '@/store/useGameStore';
  ...
  const generateChallenge = useCallback(async () => {
    ...
    try {
      ...
      const apiRequest = {
        ...
        difficulty: (focus as FocusArea & { preferredDifficulty?: string })?.preferredDifficulty || 'intermediate',
      };
      ...
      if (result.success && result.data) {
        ...
        const challengeContent = challengeData.description || challengeData.title || JSON.stringify(challengeData);
