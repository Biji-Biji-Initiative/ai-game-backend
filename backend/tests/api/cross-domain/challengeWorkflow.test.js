...
describe('Challenge Workflow with Real APIs', function () {
    ...
    it('should generate a challenge using our domain model', async function () {
        ...
        const challenge = await challengeService.generateChallenge(testUser.id, 'Effective Questioning', {
            difficulty: 'medium',
    ...
    `;
        ...
        const completedChallenge = await challengeService.completeChallenge(this.challenge.id, testUser.id, userResponse, 85);
