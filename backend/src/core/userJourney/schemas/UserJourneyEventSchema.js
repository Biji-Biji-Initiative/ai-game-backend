...
const UserJourneyEventAnalyticsSchema = z
    ...
    .strict();
export { UserJourneyEventSchema };
export { UserJourneyEventCreateSchema };
export { UserJourneyEventDatabaseSchema };
export { UserJourneyEventQuerySchema };
export { UserJourneyEventAnalyticsSchema };
export { eventTypes };
export default {
