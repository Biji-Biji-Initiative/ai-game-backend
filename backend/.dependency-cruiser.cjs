    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          '(^|/)src/core/(?:.*?)/schemas/[^/]+Schema[.]js$',                  // Schema files often used by container
          '(^|/)src/core/infra/http/responseFormatter[.]js$',                 // Used by middleware/outside core
          '(^|/)src/core/common/fallbackChallenges[.]js$',                    // Potential utility
          '(^|/)src/core/infra/api/responsesApiTypes[.]js$'                   // Types used outside core
        ]
      },
      to: {},
    },
    ...
    */
    ...
    enhancedResolveOptions: {
      ...
      */
      ...
      mainFields: ["main", "module", "imports"],
...
// generated: dependency-cruiser@16.10.0 on 2025-04-01T12:41:22.889Z
