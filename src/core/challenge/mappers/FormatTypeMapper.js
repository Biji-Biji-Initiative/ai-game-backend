 ...
 * Format Type Mapper
 *
 * Handles conversion between FormatType domain entities and persistence format.
...
class FormatTypeMapper {
  ...
  toPersistence(formatType) {
    ...
    return {
      ...
      created_at:
        formatType.createdAt instanceof Date
          ? formatType.createdAt.toISOString()
          : formatType.createdAt,
      updated_at:
        formatType.updatedAt instanceof Date
...
module.exports = new FormatTypeMapper();
