...
/**
 * FocusAreaConfig Mapper
 *
 * Handles conversion between FocusAreaConfig domain entities and persistence format.
 * This mapper decouples domain entities from persistence concerns following DDD principles.
 */

const FocusAreaConfig = require('../models/config/FocusArea');
...
class FocusAreaConfigMapper {
  ...
  toPersistence(focusAreaConfig) {
    ...
    return {
      ...
      created_at:
        focusAreaConfig.createdAt instanceof Date
          ? focusAreaConfig.createdAt.toISOString()
          : focusAreaConfig.createdAt,
      updated_at:
        focusAreaConfig.updatedAt instanceof Date
...
module.exports = new FocusAreaConfigMapper();
