 ...
 * Focus Area Mapper
 *
 * Handles conversion between FocusArea domain entities and persistence format.
...
class FocusAreaMapper {
  ...
  toPersistence(focusArea) {
    ...
    return {
      ...
      created_at:
        focusArea.createdAt instanceof Date
          ? focusArea.createdAt.toISOString()
          : focusArea.createdAt,
      updated_at:
        focusArea.updatedAt instanceof Date
...
module.exports = new FocusAreaMapper();
