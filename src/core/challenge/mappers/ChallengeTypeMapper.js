...
/**
 * Challenge Type Mapper
 *
 * Handles conversion between ChallengeType domain entities and persistence format.
 * Following the Data Mapper pattern to separate domain logic from persistence concerns.
 */
...
class ChallengeTypeMapper {
  ...
  toDomain(data) {
    ...
    const challengeType = new ChallengeType({
      ...
      defaultEvaluationCriteria:
        data.default_evaluation_criteria || data.defaultEvaluationCriteria || [],
  ...
  toPersistence(challengeType) {
    ...
    return {
      ...
      created_at:
        challengeType.createdAt instanceof Date
          ? challengeType.createdAt.toISOString()
          : challengeType.createdAt,
      updated_at:
        challengeType.updatedAt instanceof Date
...
module.exports = new ChallengeTypeMapper();
