 ...
 *
 * Handles conversion between DifficultyLevel domain entities and persistence format.
...
class DifficultyLevelMapper {
  ...
  toPersistence(difficultyLevel) {
    ...
    return {
      ...
      created_at:
        difficultyLevel.createdAt instanceof Date
          ? difficultyLevel.createdAt.toISOString()
          : difficultyLevel.createdAt,
      updated_at:
        difficultyLevel.updatedAt instanceof Date
...
module.exports = new DifficultyLevelMapper();
