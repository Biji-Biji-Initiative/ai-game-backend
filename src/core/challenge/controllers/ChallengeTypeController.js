 ...
 * 
 * Handles HTTP requests related to challenge types.
...
const { ChallengeTypeDTOMapper } = require('../dtos/ChallengeTypeDTO');
const { withControllerErrorHandling } = require('../../infra/errors/errorStandardization');
...
class ChallengeTypeController {
  ...
  constructor(challengeTypeRepository = null) {
    ...
    this.logger = logger.child({ controller: 'ChallengeTypeController' });
    
    // Apply standardized error handling to all controller methods
    this.getAllChallengeTypes = withControllerErrorHandling(
      this.getAllChallengeTypes.bind(this),
      { methodName: 'getAllChallengeTypes', domainName: 'challenge', logger: this.logger }
    );
    
    this.getChallengeTypeById = withControllerErrorHandling(
      this.getChallengeTypeById.bind(this),
      { methodName: 'getChallengeTypeById', domainName: 'challenge', logger: this.logger }
    );
    
    this.getChallengeTypeByCode = withControllerErrorHandling(
      this.getChallengeTypeByCode.bind(this),
      { methodName: 'getChallengeTypeByCode', domainName: 'challenge', logger: this.logger }
    );
    
    this.getChallengeTypesByFormat = withControllerErrorHandling(
      this.getChallengeTypesByFormat.bind(this),
      { methodName: 'getChallengeTypesByFormat', domainName: 'challenge', logger: this.logger }
    );
    
    this.getChallengeTypesByFocusArea = withControllerErrorHandling(
      this.getChallengeTypesByFocusArea.bind(this),
      { methodName: 'getChallengeTypesByFocusArea', domainName: 'challenge', logger: this.logger }
    );
    
    this.createChallengeType = withControllerErrorHandling(
      this.createChallengeType.bind(this),
      { methodName: 'createChallengeType', domainName: 'challenge', logger: this.logger }
    );
    
    this.updateChallengeType = withControllerErrorHandling(
      this.updateChallengeType.bind(this),
      { methodName: 'updateChallengeType', domainName: 'challenge', logger: this.logger }
    );
    
    this.deleteChallengeType = withControllerErrorHandling(
      this.deleteChallengeType.bind(this),
      { methodName: 'deleteChallengeType', domainName: 'challenge', logger: this.logger }
    );
  }
  ...
  async getChallengeTypesByFocusArea(req, res) {
    const { focusAreaCode } = req.params;
...
module.exports = ChallengeTypeController; 