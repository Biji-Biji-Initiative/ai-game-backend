...
/**
 * Challenge Schema Definitions using Zod
 *
 * Defines comprehensive validation schemas for Challenge entities.
        ...
        .array(
          z
            ...
            .refine(
              ...
              'Metrics cannot start or end with whitespace'
            )
        )
  ...
  .object({
    ...
    additionalContext: z
      ...
      .refine(
        ...
        'Additional context cannot start or end with whitespace'
      )
      .optional()
  ...
  .object({
    ...
    allowedResources: z
      .array(
        z
          ...
          .refine(
            resource => resource.trim() === resource,
            'Resources cannot start or end with whitespace'
          )
      )
    ...
    submissionFormat: z
      ...
      .refine(
        ...
        'Submission format cannot start or end with whitespace'
      )
        ...
        z
          .object({
            ...
            response: z
              ...
              .describe('User's response content'),
            submittedAt: z
              .string()
