 ...
 * Progress Mapper
 *
 * Handles conversion between Progress domain entities and persistence format.
...
class ProgressMapper {
  ...
  toPersistence(progress) {
    ...
    const skillLevels =
      typeof progress.skillLevels === 'object'
    ...
    return {
      ...
      created_at:
        progress.createdAt instanceof Date ? progress.createdAt.toISOString() : progress.createdAt,
      updated_at:
...
module.exports = new ProgressMapper();
