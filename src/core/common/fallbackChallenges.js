...
const getFallbackChallenge = (focusArea = 'critical thinking', challengeType = 'scenario') => {
  ...
  const challenge = FALLBACK_CHALLENGES.find(
    c =>
      c.focusArea.toLowerCase() === focusArea.toLowerCase() &&
...
const FALLBACK_CHALLENGES = [
  {
    ...
    content: {
      prompt:
        'You have discovered a new AI tool that claims it can write perfect essays on any topic. How would you evaluate this claim? What questions would you ask to test it? What critical thinking strategies would you apply?',
      context:
        'In today's world, we are bombarded with new AI technologies that make bold claims. Critical evaluation of these claims is an essential skill.',
      timeEstimate: 600,
    },
    evaluationCriteria: {
  ...
  },
  {
    ...
    content: {
      prompt:
        'Write a thoughtful essay exploring the ethical implications of using AI systems to grade student essays and provide feedback. Consider benefits, risks, and potential safeguards.',
      context:
        'Educational institutions are increasingly looking to AI to help manage workloads and provide timely feedback to students. This raises important ethical questions about assessment, feedback, and the teacher-student relationship.',
      timeEstimate: 900,
    },
    evaluationCriteria: {
