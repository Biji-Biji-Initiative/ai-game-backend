...
export const findTraitById = id => personalityTraits.find(trait => trait.id === id);
export const findAttitudeById = id => aiAttitudes.find(attitude => attitude.id === id);
export const getTraitIds = () => personalityTraits.map(trait => trait.id);
export const getAttitudeIds = () => aiAttitudes.map(attitude => attitude.id);
