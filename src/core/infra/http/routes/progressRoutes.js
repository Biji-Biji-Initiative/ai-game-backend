...
router.get('/challenge/:challengeId', authenticateUser, (req, res) =>
  progressController.getChallengeProgress(req, res)
);

// Record a challenge completion
router.post('/complete', authenticateUser, (req, res) =>
  progressController.recordChallengeCompletion(req, res)
);

// Update skill levels
router.put('/skills', authenticateUser, (req, res) =>
  progressController.updateSkillLevels(req, res)
);

// Set focus area
router.put('/focus-area', authenticateUser, (req, res) =>
  progressController.setFocusArea(req, res)
);
