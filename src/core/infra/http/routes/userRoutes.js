...
router.put('/me', authenticateUser, validateBody(updateUserSchema), (req, res, next) =>
...
router.get('/:id', authenticateUser, requireAdmin, validateParams(userIdSchema), (req, res, next) =>
  userController.getUserById(req, res, next)
);

router.get('/', authenticateUser, requireAdmin, (req, res, next) =>
