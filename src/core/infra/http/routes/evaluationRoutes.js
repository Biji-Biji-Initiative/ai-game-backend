...
router.get('/user/:userId', authenticateUser, (req, res) =>
  evaluationController.getEvaluationsForUser(req, res)
);

// Get evaluations for a specific challenge
router.get('/challenge/:challengeId', authenticateUser, (req, res) =>
  evaluationController.getEvaluationsForChallenge(req, res)
);

// Stream an evaluation for a challenge response
router.post('/stream', authenticateUser, (req, res) =>
  evaluationController.streamEvaluation(req, res)
);
