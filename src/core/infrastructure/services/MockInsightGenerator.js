...
class MockInsightGenerator extends InsightGenerator {
  ...
  async generateFor(profile) {
    this.logger.debug('Generating mock insights', { userId: profile.userId });
    ...
    const mockInsights = {
      strengths: [
        ...
        "Ability to integrate creative and technical concepts"
      ],
      focus_areas: [
        "Logic and reasoning",
      ...
      recommendations: [
        "Further develop technical writing skills for complex topics",
        "Explore more collaborative projects that leverage your communication strengths",
        "Consider joining communities that focus on innovation and creative problem-solving"
      ],
      traits: {
        analytical: {
    ...
    this.logger.info('Generated mock insights', { userId: profile.userId });
    return mockInsights;
  }
}

module.exports = MockInsightGenerator; 