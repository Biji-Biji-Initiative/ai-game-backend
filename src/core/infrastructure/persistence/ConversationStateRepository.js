 ...
 */
const { dbLogger } = require('../logging/domainLogger');
const { supabaseClient } = require('../persistence/supabaseClient');
...
class ConversationStateRepository {
  ...
  async updateState(stateId, updates) {
    try {
      ...
      const dbUpdates = {};
      if (updates.lastResponseId !== undefined) dbUpdates.lastResponseId = updates.lastResponseId;
