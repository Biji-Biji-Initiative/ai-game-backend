...
/**
 * Focus Area Validation Service
 * 
 * This service provides focus area validation functions that check both
 * format (using the FocusArea value object) and existence (using the repository).
 */

const { FocusArea } = require('../../common/valueObjects');
...
module.exports = FocusAreaValidationService; 