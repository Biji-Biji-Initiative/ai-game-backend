...
class UserJourneySummaryDTO {
    ...
    toJSON() {
        return {
            ...
            firstActivityDate: this.firstActivityDate instanceof Date
                ? this.firstActivityDate.toISOString()
                : this.firstActivityDate,
            lastActivityDate: this.lastActivityDate instanceof Date
...
class UserJourneyDTOMapper {
    ...
    static fromRequest(requestBody) {
        ...
        const { userId, userEmail, eventType, eventData, sessionId, deviceInfo, clientVersion } = requestBody;
...
export { UserJourneyDTO };
export { UserJourneySummaryDTO };
export { UserJourneyDTOMapper };
export default {
    UserJourneyDTO,
