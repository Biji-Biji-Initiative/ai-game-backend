 ...
 *
 * Application-level coordinator responsible for orchestrating user progress tracking
 * and reporting operations. Following the Single Responsibility Principle, this coordinator
 * focuses exclusively on progress-related domain operations.
 *
 * The coordinator acts as an orchestration layer between the API/controllers and the
 * domain services, ensuring proper coordination of repositories and domain events.
 *
