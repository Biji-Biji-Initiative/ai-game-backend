...
import challengeThreadService from "../../../src/core/challenge/services/challengeThreadService";
import challengeGenerationService from "../../../src/core/challenge/services/challengeGenerationService";
import challengeEvaluationService from "../../../src/core/challenge/services/challengeEvaluationService";
...
async function testChallengeGenerationService() {
    ...
    try {
        ...
        const challenge = await challengeGenerationService.generateChallenge(testUser, testChallengeParams, [], options);
...
async function testChallengeEvaluationService() {
    ...
    try {
        ...
        const threadMetadata = await challengeThreadService.createEvaluationThread(testUser.email, challenge.id);
        if (!threadMetadata || !threadMetadata.id) {
        ...
        const evaluation = await challengeEvaluationService.evaluateResponses(challenge, responses, options);
        if (evaluation) {
