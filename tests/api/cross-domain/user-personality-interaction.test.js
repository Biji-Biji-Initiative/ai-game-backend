 ...
 * 
 * End-to-end tests of the interaction between User and Personality domains
 * using real API calls and Supabase connections.
 */
const axios = require('axios');
const { expect } = require('chai');
const { setupTestUser, cleanupTestUser, getAuthToken } = require('../../helpers/apiTestHelper');
...
describe('User-Personality Domain Integration (Real)', function() {
  ...
  describe('Focus Area Change & Personality Insights', function() {
    it('should update focus area and regenerate personality insights', async function() {
      ...
      // The actual assertion would depend on your implementation
      // but insights should reflect the focus area if that's part of your design
    });
  });
  ...
  describe('AI Attitudes Update & User AI Preferences', function() {
    it('should update AI attitudes and affect user AI interaction preferences', async function() {
      ...
      // The actual assertion would depend on your implementation
      // but user preferences should reflect AI attitudes
    });
  });
