/**
 * Traits Analysis Service Unit Tests
 * 
 * Tests trait analysis domain logic in isolation 
 */
const { expect } = require('chai');
const sinon = require('sinon');
const TraitsAnalysisService = require('../../src/core/personality/services/TraitsAnalysisService');
const { NoPersonalityDataError } = require('../../src/core/personality/errors/PersonalityErrors');
...
describe('Traits Analysis Service', () => {
  ...
  describe('analyzeAiAttitudes', () => {
    it('should correctly analyze AI attitudes and create a profile', () => {
      ...
      // Assert - Update to match actual implementation
      expect(profile).to.have.property('overall');
      expect(profile).to.have.property('score').that.is.a('number');
  ...
  describe('calculateTraitCompatibility', () => {
    it('should correctly calculate trait compatibility score', () => {
      ...
      // Act
      const score = traitsAnalysisService.calculateTraitCompatibility(
        personalityTraits, 
        challengeTraits
      );
