/**
 * Prompt Builder Domain Test
 * 
 * Tests the prompt builder functionality using real components
 * instead of relying on mocks for most dependencies.
 */

const { expect } = require('chai');
const testSetup = require('./setup');
const { createTestUser, createTestChallenge } = require('../../helpers/testFactory');
...
describe('Prompt Builder Domain', function() {
  ...
  describe('Focus Area Prompt Building', function() {
    it('should build a focus area prompt with user data', async function() {
      ...
      const hasTraitMentioned = user.personality_traits.some(trait => 
