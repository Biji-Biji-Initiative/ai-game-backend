/**
 * Real API Tests for Personality Endpoints
 * 
 * These tests make actual API calls to the Personality endpoints with real Supabase connections.
 */
  ...
  describe('GET /personality/profile', function() {
    ...
    it('should accept query parameters', async function() {
      ...
      const response = await axios.get(
        `${API_URL}/personality/profile?includeInsights=true&includeTraits=true`, 
        {
          headers: {
            'Authorization': `Bearer ${authToken}`
          }
