 ...
 * User Service Tests
 * 
 * These tests validate the behavior of the UserService using an in-memory repository,
 * focusing on domain logic rather than infrastructure concerns.
 */
...
const InMemoryUserRepository = require('../../src/test/repositories/InMemoryUserRepository');
const { EventTypes } = require('../../src/core/common/events/domainEvents');
...
const userModule = require('../../src/core/user/models/User');
...
describe('User Service', () => {
  ...
  beforeEach(() => {
    ...
    sinon.stub(require('../../src/core/common/events/domainEvents'), 'eventBus').get(() => eventBusMock);
  });
