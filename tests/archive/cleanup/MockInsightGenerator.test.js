/**
 * Mock Insight Generator Unit Tests
 * 
 * Tests the MockInsightGenerator adapter implementation.
 */
const { expect } = require('chai');
const sinon = require('sinon');
const MockInsightGenerator = require('../../src/infrastructure/services/MockInsightGenerator');
