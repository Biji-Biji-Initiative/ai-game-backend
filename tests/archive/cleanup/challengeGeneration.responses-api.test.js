/**
 * Challenge Generation - Responses API Integration Test
 * 
 * Tests the integration between ChallengeGenerationService and OpenAI's Responses API
 * using the ACTUAL implementation from src with real API calls.
 */
