 ...
 * 
 * Tests user controller handling of HTTP requests
 */
const { expect } = require('chai');
const sinon = require('sinon');
const UserController = require('../../src/core/user/controllers/UserController');
const { 
  UserNotFoundError, 
  FocusAreaError 
} = require('../../src/core/user/errors/UserErrors');
