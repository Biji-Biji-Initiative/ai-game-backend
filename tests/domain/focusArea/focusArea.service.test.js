        ...
        focusAreaService = {
            recommendFocusArea: async (userProfile) => {
              ...
              skills: An array of 3-5 specific skills to develop in this focus area`
                    ...
                    const assistantMessage = completion.output.find(item => item.type === 'message' && item.role === 'assistant');
                    ...
                    throw new FocusAreaError(`Failed to recommend focus area: ${error.message}`);
                }
            },
