...
import { ChallengeValidationError } from '../../../src/core/challenge/errors/ChallengeErrors.js';
...
describe('Challenge Domain Model', function () {
    describe('Challenge Creation', function () {
        ...
        it('should throw an error when required fields are missing', function () {
            ...
            // Verify errors are thrown - update to expect domain-specific errors
            expect(createWithoutTitle).to.throw(ChallengeValidationError);
            expect(createWithoutContent).to.throw(ChallengeValidationError);
        });
    });
