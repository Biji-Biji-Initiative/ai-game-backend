 ...
 * 
 * This file serves as a template for creating domain tests following
 * our testing principles. Domain tests focus on testing domain objects,
 * services, and repositories within a single domain.
 * 
 * To use this template:
 * 1. Copy to the appropriate domain directory
 * 2. Rename to match the component being tested (e.g., user.service.test.js)
 * 3. Modify the imports and test cases as needed
 */
