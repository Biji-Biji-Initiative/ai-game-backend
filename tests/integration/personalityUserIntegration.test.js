/**
 * Personality-User Integration Tests
 * 
 * Tests cross-domain coordination between the Personality and User domains.
 */
const { expect } = require('chai');
const sinon = require('sinon');
const PersonalityCoordinator = require('../../src/application/PersonalityCoordinator');
const UserService = require('../../src/core/user/services/UserService');
const User = require('../../src/core/user/models/User');
const { EventTypes, eventBus } = require('../../src/core/shared/domainEvents');
const { appLogger } = require('../../src/core/infra/logging/appLogger');
...
describe('Personality-User Integration', () => {
  ...
  describe('Preference synchronization', () => {
    ...
    it('should update user preferences when personality profile event is triggered', async () => {
      ...
      const { registerEventHandlers } = require('../../src/application/EventHandlers');
