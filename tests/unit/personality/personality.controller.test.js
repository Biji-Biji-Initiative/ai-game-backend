/**
 * Personality Controller Unit Tests
 * 
 * Tests personality controller handling of HTTP requests
 */
const { expect } = require('chai');
const sinon = require('sinon');
const PersonalityController = require('../../src/core/personality/controllers/PersonalityController');
const { 
...
} = require('../../src/core/personality/errors/PersonalityErrors');
