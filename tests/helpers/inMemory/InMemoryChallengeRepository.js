 ...
 * 
 * This is a test double (fake) implementation of the ChallengeRepository
 * that stores data in memory for unit testing purposes.
 */
...
module.exports = InMemoryChallengeRepository; 